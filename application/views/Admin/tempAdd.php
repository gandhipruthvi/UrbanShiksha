                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Image</th>
                                    <th>ContactNo</th>
                                    <th>AdminAddedDate</th>
                                    <th>Edit</th>
                                </tr>
                            </thead>                            
                            <tbody>
                                <?php
                                foreach ($adminD as $key)
                                {
                                    ?>
                                    <tr>
                                        <td><?= $key->adminID?></td>
                                        ...
                                        <td><?= $key->email?></td>
                                        <td><?= $key->userName?></td>
                                        <td><img src="<?= base_url("upload/$key->image")?>" height="100" width="100"></td>
                                        <td><?= $key->contactNo?></td>
                                        <td><?= $key->adminAddedDate?></td>
                                        <td><?= anchor("Admin/AdminC/updData/".$key->adminID,"<i class='zmdi zmdi-edit'></i>")?></td>
                                    </tr>
                                    <?php
                                }
                                ?>                                
