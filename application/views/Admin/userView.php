                                ...
                                foreach ($userD as $key)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="switch">
                                                <label>
                                                    <input type="checkbox" class="status-group" data-id="<?= $key->userID?>" <?php 
                                                    if($key->status == 0)
                                                        echo "checked";
                                                    ?>>
                                        ...
                                        <td><?=anchor("Admin/RatingC/index/".$key->userID,"<i class='zmdi zmdi-info' style='color:black;'></i><span style='color:black;'>  MoreInfo</span>")?></td>
                                    </tr>
                                    <?php
                                }
                                ?>                                
...
<script type="text/javascript">
    $(".status-group").change(function(){
        var id=$(this).data("id");
        $.ajax({
            url : "<?= site_url("Admin/UserC/statusChange/")?>"+id,
