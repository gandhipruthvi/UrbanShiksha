...
<div class="left-sidebar-pro">
	<nav id="sidebar" class="">
		<div class="sidebar-header">
			...
			<strong><a href="index.html"><img src="iresources/img/logo/logosn.png" alt="" /></a></strong>
		</div>
			...
			<nav class="sidebar-nav left-sidebar-menu-pro">
				<ul class="metismenu" id="menu1">
					...
					<li class="active">
						...
						<ul class="submenu-angle" aria-expanded="false">
							<li><a title="All Courses" href="<?= site_url("Instructor/CourseC")?>"><span class="mini-sub-pro">All Courses</span></a></li>
